...
<body>
	...
	<div id="Toys" class="tabcontent">
		...
		<div class="container" style="margin-top: 20px">
			<div class="col-md-12">
				<table id="table5" class="display table table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th> No</th>
						<th> ID</th>
	...
	<div id="Clothes" class="tabcontent">
		...
		<div class="container" style="margin-top: 20px">
			<div class="col-md-12">
				<table id="table6" class="display table table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th> No</th>
						<th> ID</th>
